...
//shooters
  ...
  /*
    ...
    newAsteroid=function(){ // new Asteroid?
        ...
        a.A();
        a.start()}
    cjs.Asteroid = Asteroid= function(  x,y,r,vx,vy, st){
...
J.scSh= cjs.scaleShake = function(bm){$Tw(  [bm,'l'  ],  {sxy:1},  [ {  sxy:.95}, 1],  [ { sxy:1.05 },1] ) }
...
que=function(){
    ...
    Cycle2=function(x,y){
      ct=  c= cont= $Ct()
        var qu =  new cjs.LoadQueue().complete( graphics )
