cjs.SL = cjs.bindSlide = SL = function () {var g = G(arguments), b = g.f, b2 = g.s || b; return b.on('mousedown', function (e) {var bx = b2.x - e.rawX, by = b2.y - e.rawY
...
cjs.LS = cjs.bindReverseSlide = LS = function (b, b2) {
    ...
    return b.on(d, function (e) {var bx = b2.x + e.rawX, by = b2.y + e.rawY
        b.on(pm, function (e) {
...
cjs.RT = cjs.bindRotate = RT = function (b, b2) {//b = what the control is
...
cjs.bindRotate = RT = function (b, b2) {//b = what the control is
    //b2 what it should control (default = itself!)
    //if(g.p){  //b.rgc( '+' )   }
    var g = G(arguments), b = g[0], b2 = g[1] || b
    return b.on('mousedown', function (e) {var X = e.rawX, Y = e.rawY, r = b2.rotation
            b.on('pressmove', function (e) {
                b2.rotation = r - (   (e.rawY - Y) / 500   ) - (   e.rawX - X  )
            })
        })
